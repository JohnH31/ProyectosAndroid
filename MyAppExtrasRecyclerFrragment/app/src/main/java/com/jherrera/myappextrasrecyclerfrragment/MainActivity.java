...
public class MainActivity extends AppCompatActivity {
            ...
            public void onItemClick(int position, View v) {
                ...
                switch (position){
                    case 0:
                        ...
                        intent.putExtra("especificacion",listVO2.get(position).getEspecificaciones());
    ...
    public void insertarDatos(){
        listVO.add(new DatosVO(R.drawable.design,"Computadora"));
        listVO.add(new DatosVO(R.drawable.design,"Smartphone"));
        listVO.add(new DatosVO(R.drawable.design,"Audifonos"));
        listVO.add(new DatosVO(R.drawable.design,"Television"));
    }
