package com.jherrera.myappswlocal.complementos;
...
public class MetodosSW {
    ...
    public void insertarSW(Context context, String nombre, String apellido, int telefono,
                           String direccion, Response.Listener listener, Response.ErrorListener errorListener){
    ...
    //metodo actualizar
    public void actualizarSW(Context context, int id, String nombre, String apellido, int telefono,
                             String direccion, Response.Listener listener,
                           Response.ErrorListener errorListener) {
        this.context = context;
        try {
            String url;
            url = IP_SERVER+"cliente_sw/actualizar_sw.php?id_cliente="+id+"&nombre_cliente="+nombre+"&apellido_cliente="+
                    apellido+"&telefono_cliente="+telefono+"&direccion_cliente="+direccion;
            requestQueue = Volley.newRequestQueue(context);
            jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, listener, errorListener);
            requestQueue.add(jsonObjectRequest);
        } catch (Exception e) {
